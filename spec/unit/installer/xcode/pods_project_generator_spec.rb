      ...
      describe PodsProjectGenerator do
        describe 'Generating Pods Project' do
          ...
          it 'adds system frameworks to dynamic targets' do
            @orangeframework_pod_target.stubs(:type => Target::Type.dynamic_framework)
            pod_generator_result = @generator.generate!
          ...
          it 'adds framework file references for framework pod targets that require building' do
            @orangeframework_pod_target.stubs(:type).returns(Target::Type.dynamic_framework)
            @coconut_ios_pod_target.stubs(:type).returns(Target::Type.dynamic_framework)
