    ...
    describe '#scope_suffixes' do
      ...
      it 'returns scopes by built types if they qualify' do
        variants = PodVariantSet.new([
          PodVariant.new([@root_spec], [], [], Platform.ios, Target::Type.dynamic_framework),
      ...
      it 'returns scopes by built types, versioned platform names and subspec names' do
        variants = PodVariantSet.new([
          PodVariant.new([@root_spec, @default_subspec], [], [], Platform.new(:ios, '7.0')),
          PodVariant.new([@root_spec, @default_subspec], [], [], Platform.ios),
          PodVariant.new([@root_spec, @default_subspec], [], [], Platform.osx, Target::Type.dynamic_framework),
          PodVariant.new([@root_spec, @default_subspec, @foo_subspec], [], [], Platform.osx, Target::Type.dynamic_framework),
        ])
        variants.scope_suffixes.values.should == %w(
          library-iOS7.0
          library-iOS
      ...
      it 'returns scopes differentiating build types' do
        variants = PodVariantSet.new([
          PodVariant.new([@root_spec, @default_subspec], [], [], Platform.ios),
          PodVariant.new([@root_spec, @default_subspec], [], [], Platform.ios, Target::Type.dynamic_framework),
          PodVariant.new([@root_spec, @default_subspec], [], [], Platform.ios, Target::Type.static_framework),
        ])
        variants.scope_suffixes.values.should == %w(
          library
          framework-dynamic
