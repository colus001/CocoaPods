          ...
          def add_copy_resources_script_phase(native_target, test_spec)
            ...
            unless installation_options.disable_input_output_paths?
              ...
              unless resource_paths.empty?
                input_file_list_path = target.embed_frameworks_script_input_files_path_for_test_spec(test_spec)
                ...
                output_file_list_path = target.embed_frameworks_script_output_files_path_for_test_spec(test_spec)
